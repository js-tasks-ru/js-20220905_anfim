...
export default class ProductForm {
  ...
  sortableListModule () {
    const sortableList = new SortableList({
      items: this.product.images.map(item => {
  ...
  getSubElements () {
    ...
    subElements.imageListContainer = this.element.querySelector('[data-element="imageListContainer"]')
    return subElements
  }
  ...
  imagesTemplate(item) {
    return `
          <li class="products-edit__imagelist-item sortable-list__item" style="">
            ...
            <span>
              <img src="icon-grab.svg" data-grab-handle="" alt="grab" draggable="false">
